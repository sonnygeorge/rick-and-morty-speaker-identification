...
| ------ | ----- | --- | ---- |
| Accuracy | 0.514 | 0.523 | 0.485 |
| Macro F1 | 0.333 | 0.307 | 0.28 |
...
| Morty | 0.67 | 0.12 | 0.21 |
| Rick | 0.51 | 0.96 | 0.67 |
| Summer | 1.00 | 0.27 | 0.43 |
...
| Method | Importance |
| ------ | ---------- |
| Familial Words & Common Names 1-Gram Counts | 1.0000 |
| Familial Words & Common Names 1-Gram One Hots | 0.0000 |
...
| Feature | Importance |
| ------- | ---------- |
| count(beth) | 0.15071186423301697 |
| count(morty) | 0.14952746033668518 |
| count(jerry) | 0.13563470542430878 |
| count(um) | 0.11706249415874481 |
| count(jessica) | 0.11378347873687744 |
| count(rick) | 0.10096425563097 |
| count(father) | 0.07086028158664703 |
| count(grandpa) | 0.05960800498723984 |
| count(dad) | 0.05758824571967125 |
| count(summer) | 0.02775341272354126 |
| count(mom) | 0.01650574617087841 |
| has(summer) | 0.0 |
| has(mother) | 0.0 |
| has(jessica) | 0.0 |
| has(mom) | 0.0 |
