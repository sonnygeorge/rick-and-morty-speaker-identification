...
| Method | Importance |
| ------ | ---------- |
| Average Tokens Per Sentence | 0.3211 |
...
| Feature | Importance |
| ------- | ---------- |
| avg_tokens_per_sentence | 0.3211112916469574 |
| avg_root_verb_embedding_12 | 2.3857863384532663e-13 |
...
| avg_root_verb_embedding_6 | -4.392233867329129e-15 |
| n_root_verbs_embedded | -4.173030465019073e-14 |
| n_root_verbs | -4.9989092726354656e-14 |
| avg_token_length | -2.495695490545291e-12 |
| total_sentence_count | -0.12111128866672516 |
### 📉 Unused Features

27/32 features were unused.
